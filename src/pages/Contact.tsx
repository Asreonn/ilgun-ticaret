...
export default function Contact() {
  ...
  return <main className="page-shell contact-page">
    ...
    <div className="container contact-hero"><div><span className="eyebrow">İLETİŞİM</span><h1>Size nasıl yardımcı olabiliriz?</h1><p>Ürün, güncel fiyat, stok ve sipariş bilgisi için doğrudan iletişime geçin.</p></div><div className="contact-person"><span>İletişim</span><strong>{site.contact}</strong><small>{site.serviceArea}</small></div></div>
    <div className="container contact-layout"><section className="contact-options">
