...
export default function Products() {
  ...
  return <div className="page-shell container">
    ...
    <div className="page-heading"><span className="eyebrow">{selectedCategory ? selectedCategory.name.toLocaleUpperCase("tr-TR") : "ÜRÜN KATALOĞU"}</span><h1>{selectedCategory ? `${selectedCategory.name} ürünleri` : "İhtiyacınıza uygun ürünü bulun"}</h1><p>{selectedCategory?.description || "Ürün adı, marka veya modelle arayın; kategoriye göre filtreleyin."}</p></div>
