...
export default function Products() {
  ...
  return <div className="page-shell container catalog-page">
    ...
    <div className="page-heading"><span className="eyebrow">{selectedCategory ? selectedCategory.name.toLocaleUpperCase("tr-TR") : "ÜRÜN KATALOĞU"}</span><h1>{selectedCategory ? `${selectedCategory.name} ürünleri` : "Tüm ürünler"}</h1></div>
